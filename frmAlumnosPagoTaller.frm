...
Begin VB.Form frmAlumnosPagoTaller 
   Caption         =   "Ingreso de Alumnos al Taller de Pasantías"
   ClientHeight    =   3465
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8265
   Icon            =   "frmAlumnosPagoTaller.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   3465
   ScaleWidth      =   8265
   ...
   Begin VB.Frame Frame2 
      Height          =   1110
      Left            =   120
      MouseIcon       =   "frmAlumnosPagoTaller.frx":0442
      TabIndex        =   12
      Top             =   2280
      Width           =   8055
      Begin MSForms.CommandButton CmdOpcion 
         ...
         Size            =   "2143;1720"
         MousePointer    =   1
         Picture         =   "frmAlumnosPagoTaller.frx":074C
      ...
      Begin MSForms.CommandButton CmdOpcion 
         ...
         Size            =   "2143;1720"
         MousePointer    =   1
         Picture         =   "frmAlumnosPagoTaller.frx":0B77
         FontName        =   "Times New Roman"
         FontEffects     =   1073741825
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton CmdOpcion 
         ...
         Size            =   "2143;1720"
         MousePointer    =   1
         Picture         =   "frmAlumnosPagoTaller.frx":0FA3
         FontName        =   "Times New Roman"
         FontEffects     =   1073741825
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton CmdOpcion 
         ...
         Size            =   "2143;1720"
         MousePointer    =   1
         Picture         =   "frmAlumnosPagoTaller.frx":141C
         FontName        =   "Times New Roman"
         FontEffects     =   1073741825
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton CmdOpcion 
         ...
         Size            =   "2143;1720"
         MousePointer    =   1
         Picture         =   "frmAlumnosPagoTaller.frx":182D
         FontName        =   "Arial"
         FontEffects     =   1073741825
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton CmdOpcion 
         ...
         Size            =   "2143;1720"
         MousePointer    =   1
         Picture         =   "frmAlumnosPagoTaller.frx":1C65
         FontName        =   "Arial"
         FontEffects     =   1073741825
         FontHeight      =   165
         FontCharSet     =   0
      ...
      Begin MSForms.CommandButton CmdOpcion 
         ...
         Size            =   "2143;1720"
         MousePointer    =   1
         Picture         =   "frmAlumnosPagoTaller.frx":209C
         FontName        =   "Times New Roman"
      ...
      Begin MSForms.CommandButton CmdOpcion 
         ...
         Size            =   "2143;1720"
         MousePointer    =   1
         Picture         =   "frmAlumnosPagoTaller.frx":251D
         FontName        =   "Times New Roman"
         FontEffects     =   1073750017
         FontHeight      =   165
         FontCharSet     =   0
   ...
   End
End
Attribute VB_Name = "frmAlumnosPagoTaller"
...
Private Sub Guardar()
    ...
    Else
        ...
        Else
            ...
            Recor.Close
            SQL = ""
            SQL = "Insert Into Alumnos_Pago_Taller(Cedula,Sección,Nombres,Apellidos)"
            SQL = SQL & "Values ('" & txtCedula & "','" & UCase(txtSección) & "','" & UCase(txtNombres) & "','" & UCase(txtApellidos) & "')"
            Conex.Execute (SQL)
